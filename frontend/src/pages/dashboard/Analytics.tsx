            ...
            <CardContent className="p-5 flex-1 min-h-[350px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={data.productivity_trends} margin={{ top: 10, right: 0, left: -20, bottom: 0 }}>
                  ...
                  <Area type="monotone" dataKey="completed" stroke="var(--foreground)" strokeWidth={2.5} fillOpacity={1} fill="url(#colorCompleted)" name="Completed" activeDot={{ r: 5, fill: 'var(--foreground)' }} />
                  <Area type="monotone" dataKey="added" stroke="var(--primary)" strokeWidth={2} strokeDasharray="5 5" fillOpacity={1} fill="url(#colorAdded)" name="Added" activeDot={{ r: 4, fill: 'var(--primary)' }} />
                </AreaChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
